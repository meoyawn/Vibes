...
/**
 * Implementation of a {@link android.widget.TextClock} with native support for all the Roboto fonts.
 *
 * @author e.shishkin
 */
public class RobotoTextClock extends TextClock {
     ...
     * @see #RobotoTextClock(android.content.Context, android.util.AttributeSet, int)
     */
     ...
     * @see #RobotoTextClock(android.content.Context, android.util.AttributeSet)
     */
