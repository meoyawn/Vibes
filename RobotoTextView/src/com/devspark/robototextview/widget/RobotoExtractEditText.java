...
/**
 * Implementation of a {@link android.inputmethodservice.ExtractEditText} with native support for all the Roboto fonts.
 *
 * @author e.shishkin
 */
public class RobotoExtractEditText extends ExtractEditText {
     ...
     * @see #RobotoExtractEditText(android.content.Context, android.util.AttributeSet, int)
     */
     ...
     * @see #RobotoExtractEditText(android.content.Context, android.util.AttributeSet)
     */
