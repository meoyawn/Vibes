...
/**
 * Implementation of a {@link android.widget.ToggleButton} with native support for all the Roboto fonts.
 *
 * @author e.shishkin
 */
public class RobotoToggleButton extends ToggleButton {
     ...
     * @see #RobotoToggleButton(android.content.Context, android.util.AttributeSet, int)
     */
     ...
     * @see #RobotoToggleButton(android.content.Context, android.util.AttributeSet)
     */
