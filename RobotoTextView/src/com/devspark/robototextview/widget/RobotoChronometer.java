...
/**
 * Implementation of a {@link android.widget.Chronometer} with native support for all the Roboto fonts.
 *
 * @author e.shishkin
 */
public class RobotoChronometer extends Chronometer {
     ...
     * @see #RobotoChronometer(android.content.Context, android.util.AttributeSet, int)
     */
     ...
     * @see #RobotoChronometer(android.content.Context, android.util.AttributeSet)
     */
